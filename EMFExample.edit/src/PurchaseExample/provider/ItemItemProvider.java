/**
 */
package PurchaseExample.provider;
...
/**
 * This is the item provider adapter for a {@link PurchaseExample.Item} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ItemItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PurchaseExamplePackage.Literals.ITEM__PRICE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PurchaseExamplePackage.Literals.ITEM__QUANTITY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PurchaseExamplePackage.Literals.ITEM__NAME,
				 true,
				 false,
				 false,
	...
	public ResourceLocator getResourceLocator() {
		return PurchaseExampleEditPlugin.INSTANCE;
	}

...
/**
 * This is the item provider adapter for a {@link PurchaseExample.PurchaseOrder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PurchaseOrderItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PurchaseExamplePackage.Literals.PURCHASE_ORDER__BILL_TO,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PurchaseExamplePackage.Literals.PURCHASE_ORDER__SHIP_TO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PurchaseExamplePackage.Literals.PURCHASE_ORDER__ITEMS,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		String label = ((PurchaseOrder)object).getBillTo();
